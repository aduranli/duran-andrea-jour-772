...
```{r echo=FALSE}
census_api_key("5ee008c8b3892329420bc0b61f251ab267bc9e3f", install=TRUE)
```
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer: Howard County with the median household income being $129,549.**
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer: I asked Chat.GPT this because I wasn't understanding whether we meant a headline for a story or the table and it suggested "Household Income Estimations with Margin of Error by County in Maryland (2017-2021 ACS)." I would call this chart "Household Income Estimations by County in Maryland from 2017-2021" since the margin or error and explanation of error bars is in the chart as well as where it gets the information from (American Community Survey).  **
...
Is the difference between Calvert and Montgomery significant? **Answer: No because their error bars overlap.**

Is the difference between Howard and everyone else significant? **Answer: Yes because Howard County's error bar does not overlap with any others.**
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer: The average income for high schools that have 60% or more graduates enrolling in college is $111,448.3 and for 40% is $69,252.24.**
...
**Task** What is another question you could ask of this data? **Answer: In which counties are the schools with 60% or more students and 40% or less enrolled in college and how does that compare with the average household income of the county?**
