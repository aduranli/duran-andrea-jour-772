...
**It no longer shows any parsing errors.**
...
**There are 549 zip codes that are less than 5 characters in length. It could be incomplete data and/or there could be non-U.S. zip codes or that it's not counting "0" in the beginning or end. **
...
**There is no loan data for 2009. There are also a number of datasets that are NA, or are stated as neither Loans or Grants. Ex. "L" and one result for a "Contract."**
...
**The Department of Natural Resources/Rural Legacy Program gave the Land Preservation Trust Inc. a $60 grant. in 2009. **
...
**The headers are now lowercase and have a "_"character instead of just spaces.**
...
**The clean_name() is making all the names in the columns the same and "clean" and rename() changes the name of the grantor column into "source" and then the mutate() is making the datasets in the "source," "grantee," and "description" columns capitalized using the str_to_upper function. ** 
...
**The Maryland Tourism Board gave the most money to 21202 zip code 15 times to the total amount of 8464101.0. The zip code for this is Old Town, Penn-Fallsway, and East Baltimore in Baltimore City and it makes a lot of sense that this would be the recipient of the most money from the Maryland Tourism Board since Baltimore is a big tourist destination (includes the Peabody Library and the National Aqaurium, Little Italy, and a lot of the Inner Harbor). **

```{r}

maryland_tourism_board <- cleaned_md_grants_loans |> 
