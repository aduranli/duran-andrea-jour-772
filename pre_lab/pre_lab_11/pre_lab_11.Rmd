...
**Answer This gives a dataset with 4 columns that describe the date, title, url, and text.**  
...
**Answer: It makes it so that the there are only unique value for each value.**
...
**Answer: This puts all the words found into a single list.**
...
**Answer This isn't super interesting because this doesn't have anything that is unexpected.**
...
**Answer: This is definitely more interesting than before because now we have words that actually mean something on their own. So the top words have to do with health, funding, and communities and Baltimore. **
...
**Answer: the top words are act, national, and health. Followed by communities, women, legislation, and american and rights. So just by that, we can at least tell that these topics are of great importance to Cardin but we still do not how how so. (We cannot infer anything else. Is he for? Against? What is being done?).**
...
**Task** Run the following code and describe the results.
**Answer: Now the results show us that he talks a lot about public health (covid 19, human rights, and pandemic are the top three results). Followed by rescue plan, american rescue, chesapeake bay, and health care.**
...
**Task** Run the following code and describe the results.
**Answer: This time health care is still important, but projects are more as well as PG County and Baltimore City.  **
...
**Task** Run the following code and describe the results.
**Answer: Equal rights, human rights, health care and tax credits are among the most words for 2023.**
...
**Answer: I don't think "enough" is necessarily positive, I cannot think of an instance where it is unequivocally positive because usually it means to imply that something should stop.**
