...
**Answer** **The columns are very specific. They state the date and the news release/news item but for coding we still need to clean them.
...
**Answer** **I would add a column for "characters" or "organization" so it's easier to parse who the releases are about.**
...
**Answer** **We have a list of the entire webpage.**
...
**Answer** **We got a dataframe from another site where we have loaded in all the data into R and cleaned it so that now we can work with it.**
